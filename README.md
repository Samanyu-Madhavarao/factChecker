...
## How we built it
The backend was developed in Python and makes use of both OpenAI and Twelvelabs to analyze content, with OpenAI being called for text-based articles and Twelvelabs being used for video content in the form of YouTube links or direct mp4 uploads. The frontend was developed using HTML and CSS, with Flask being used to set up a framework that connects the two.
